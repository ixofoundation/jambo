...
import styles from './wallet-form.module.scss';
...
const WalletForm = ({ onSubmit, submitRef }: HeaderProps) => {
	...
	return (
		<form onSubmit={handleSubmit} className={styles.walletForm} autoComplete="none">
			...
			<Input label="Enter Password:" type="password" name="password" required onChange={handleChange} value={password} autoComplete="new-password" />
			<Input label="Confirm Password:" type="password" name="confirmPassword" required onChange={handleChange} value={confirmPassword} autoComplete="new-password" />
